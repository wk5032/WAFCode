...
////////////////////////////////////
    ...
    for (var index = 0; index < dataMenu.length; index++){
        ...
        if (fstMenu.children.length === 1){//First layer menu directly links to the third layer menu
	...
	var menu_footer = '<div id="menu-footer" onClick="javascript:window.open(\'http://www.hihttps.com\');"  style="cursor:pointer;">\
		<p>Copyright <span class="copyright">&copy;</span><span id="copy_year"> '+ $.su.CHAR.COPYRIGHT.COPY_YEAR +'</span></p>\
		<p>' + $.su.CHAR.COPYRIGHT.COMPANY + '</p>\
		<p>' + $.su.CHAR.COPYRIGHT.COPYRIGHT + '</p>\
	</div>';
